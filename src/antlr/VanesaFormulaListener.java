...
public interface VanesaFormulaListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link VanesaFormulaParser#function}.
	 * @param ctx the parse tree
	 */
	void enterFunction(@NotNull VanesaFormulaParser.FunctionContext ctx);
	/**
	 * Exit a parse tree produced by {@link VanesaFormulaParser#function}.
	 * @param ctx the parse tree
	 */
	void exitFunction(@NotNull VanesaFormulaParser.FunctionContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link VanesaFormulaParser#multiplicative}.
	 * @param ctx the parse tree
	 */
	void enterMultiplicative(@NotNull VanesaFormulaParser.MultiplicativeContext ctx);
	/**
	 * Exit a parse tree produced by {@link VanesaFormulaParser#multiplicative}.
	 * @param ctx the parse tree
	 */
	void exitMultiplicative(@NotNull VanesaFormulaParser.MultiplicativeContext ctx);
	/**
	 * Enter a parse tree produced by {@link VanesaFormulaParser#power}.
	 * @param ctx the parse tree
	 */
	void enterPower(@NotNull VanesaFormulaParser.PowerContext ctx);
	/**
	 * Exit a parse tree produced by {@link VanesaFormulaParser#power}.
	 * @param ctx the parse tree
	 */
	void exitPower(@NotNull VanesaFormulaParser.PowerContext ctx);
	/**
